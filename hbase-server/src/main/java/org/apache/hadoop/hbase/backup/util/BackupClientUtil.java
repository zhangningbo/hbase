...
public final class BackupClientUtil {
   ...
   * differences between hadoop versions, where hadoop 1 does not throw a FileNotFoundException,
   * and return an empty FileStatus[] while Hadoop 2 will throw FileNotFoundException.
