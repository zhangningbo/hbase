 ...
 * TestBackupSmallTests is where tests that don't require bring machines up/down should
 * go All other tests should have their own classes and extend this one
 */
